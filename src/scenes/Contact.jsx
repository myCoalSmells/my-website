      ...
      <div className="md:flex md:justify-between gap-16 mt-5">
        ...
        >
          <form
            target="_blank"
            onSubmit={onSubmit}
            action="https://formsubmit.co/2166ff313585102e70114dd1a8d8bf98"
            method="POST"
          >
            <input
            ...
            <button
              className="p-5 bg-yellow font-semibold text-deep-blue mt-5 hover:bg-red hover:text-white transition duration-500 rounded-sm"
              type="submit"
            >
              SEND ME A MESSAGE
            </button>
